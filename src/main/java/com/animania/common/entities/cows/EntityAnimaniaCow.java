...
public class EntityAnimaniaCow extends EntityCow implements IAnimaniaAnimalBase
{
	...
	public EntityAnimaniaCow(World worldIn)
	{
		...
		if (AnimaniaConfig.gameRules.animalsSleep) {
			this.tasks.addTask(1, new GenericAISleep<EntityAnimaniaCow>(this, 0.8, AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.cowBed), AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.cowBed2), EntityAnimaniaCow.class));
		}
		this.tasks.addTask(2, new GenericAITempt(this, 1.25D, false, EntityAnimaniaCow.TEMPTATION_ITEMS));
		this.tasks.addTask(2, new GenericAITempt(this, 1.25D, Item.getItemFromBlock(Blocks.YELLOW_FLOWER), false));
		this.tasks.addTask(2, new GenericAITempt(this, 1.25D, Item.getItemFromBlock(Blocks.RED_FLOWER), false));
		this.tasks.addTask(3, new GenericAIWanderAvoidWater(this, 1.0D));
		this.tasks.addTask(4, new EntityAISwimming(this));
		this.tasks.addTask(5, new GenericAIFindSaltLick(this, 1.0, entityAIEatGrass));
		if (!AnimaniaConfig.gameRules.ambianceMode) {
			this.tasks.addTask(6, new GenericAIFindWater<EntityAnimaniaCow>(this, 1.0D, entityAIEatGrass, EntityAnimaniaCow.class));
			this.tasks.addTask(6, new GenericAIFindFood<EntityAnimaniaCow>(this, 1.0, entityAIEatGrass, true));
		}
		this.tasks.addTask(7, this.entityAIEatGrass);
		this.tasks.addTask(8, new GenericAIWatchClosest(this, EntityPlayer.class, 6.0F));
		this.tasks.addTask(9, new GenericAILookIdle(this));
