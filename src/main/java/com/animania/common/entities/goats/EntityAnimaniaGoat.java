...
public class EntityAnimaniaGoat extends EntitySheep implements IAnimaniaAnimalBase
{
	...
	public EntityAnimaniaGoat(World worldIn)
	{
		...
		this.tasks.addTask(1, new GenericAIAvoidEntity(this, EntityWolf.class, 20.0F, 2.2D, 2.2D));
		if (AnimaniaConfig.gameRules.animalsSleep) {
			this.tasks.addTask(2, new GenericAISleep<EntityAnimaniaGoat>(this, 0.8, AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.goatBed), AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.goatBed2), EntityAnimaniaGoat.class));
		}
		...
		if (!AnimaniaConfig.gameRules.ambianceMode) {
			this.tasks.addTask(7, new GenericAIFindWater<EntityAnimaniaGoat>(this, 1.0D, entityAIEatGrass, EntityAnimaniaGoat.class));
			this.tasks.addTask(7, new GenericAIFindFood<EntityAnimaniaGoat>(this, 1.0, entityAIEatGrass, true));
		}
