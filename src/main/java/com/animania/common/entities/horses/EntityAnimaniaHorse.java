...
public class EntityAnimaniaHorse extends EntityHorse implements IAnimaniaAnimalBase
{
	...
	public EntityAnimaniaHorse(World worldIn)
	{
		...
		if (AnimaniaConfig.gameRules.animalsSleep) {
			this.tasks.addTask(2, new GenericAISleep<EntityAnimaniaHorse>(this, 0.8, AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.horseBed), AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.horseBed2), EntityAnimaniaHorse.class));
		}
		this.tasks.addTask(3, new GenericAITempt(this, 1.25D, false, TEMPTATION_ITEMS));
		this.tasks.addTask(4, new EntityAIWanderHorses(this, 1.0D));
		this.tasks.addTask(5, new EntityAISwimming(this));
		this.tasks.addTask(6, new GenericAIFindSaltLick(this, 1.0, entityAIEatGrass));
		if (!AnimaniaConfig.gameRules.ambianceMode) {
			this.tasks.addTask(7, new GenericAIFindWater<EntityAnimaniaHorse>(this, 1.0D, entityAIEatGrass, EntityAnimaniaHorse.class));
			this.tasks.addTask(7, new GenericAIFindFood<EntityAnimaniaHorse>(this, 1.0, entityAIEatGrass, true));
		}
		this.tasks.addTask(8, this.entityAIEatGrass);
		this.tasks.addTask(9, new GenericAIWatchClosest(this, EntityPlayer.class, 6.0F));
		this.tasks.addTask(10, new EntityAILookIdleHorses(this));
