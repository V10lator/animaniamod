...
public class EntityAnimaniaHorse extends EntityHorse implements IAnimaniaAnimalBase
{
	...
	public EntityAnimaniaHorse(World worldIn)
	{
		...
		this.tasks.addTask(3, new GenericAISearchShelter<EntityAnimaniaHorse>(this, 1.0D));
		this.tasks.addTask(4, new EntityAIWanderHorses(this, 1.0D));
		this.tasks.addTask(5, new EntityAISwimming(this));
		this.tasks.addTask(6, new GenericAITempt<EntityAnimaniaHorse>(this, 1.25D, false, TEMPTATION_ITEMS));
		this.tasks.addTask(7, this.entityAIEatGrass);
		this.tasks.addTask(8, new GenericAIWatchClosest(this, EntityPlayer.class, 6.0F));
		this.tasks.addTask(9, new EntityAILookIdleHorses(this));
		this.tasks.addTask(10, new GenericAIFindSaltLick<EntityAnimaniaHorse>(this, 1.0, entityAIEatGrass));
		if (AnimaniaConfig.gameRules.animalsSleep)
		{
			this.tasks.addTask(11, new GenericAISleep<EntityAnimaniaHorse>(this, 0.8, AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.horseBed), AnimaniaHelper.getBlock(AnimaniaConfig.careAndFeeding.horseBed2), EntityAnimaniaHorse.class));
		}
		this.tasks.addTask(12, new EntityAIHurtByTarget(this, false, new Class[0]));
